...
# logitech RGB
PARAMS_1="--webcam 0 --user-id 0 --algo 1"
DESKTOP_1="1"

# ps eye raw
PARAMS_2="--webcam 2 --user-id 1 --algo 1"
DESKTOP_2="2"

# kinect RGB
PARAMS_3="--webcam 3 --user-id 2 --algo 1"
DESKTOP_3="3"

# kinkect IR
PARAMS_4="--webcam 4 --user-id 3 --algo 0"
DESKTOP_3="4"
...
echo "Lauching soft 4 in desktop $DESKTOP_4"
#wmctrl -s $DESKTOP_4
$BINARY "cd $TARGET_FOLDER && $TARGET_COM $PARAMS_4" > /dev/null 2>&1 &
#sleep $SLEEPY
